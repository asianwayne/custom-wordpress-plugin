...
$verification_image_url = generate_verification_image($verification_code); ?>
        ...
        <div class="form-title">
            <h2 style="display:inline-block;margin-right: 5rem;" class="form-title">联系我们 </h2><span class="warning-info" style="display:none">111</span>
            <p>表格如果因为邮箱配置错误出现错误只要刷新就可以正常</p>
        </div>
