...
class Books_Management_Tool {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_handle_book_ajax', $plugin_admin, 'handle_book_ajax_cb' );
	}
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter( 'page_template', $plugin_public, 'book_tool_page_template' );
